...
func (PubliclyExposedVmAdminCVECritical) UID() string {
	return "attackpath/publicly_exposed_vm_admin_permissions_crtitical_cve"
}

func (PubliclyExposedVmAdminCVECritical) Description() string {
	return "Publicly exposed VM instance with effective admin permissions and critical cve."
}
