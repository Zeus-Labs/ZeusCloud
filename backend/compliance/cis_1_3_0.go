...
var Cis_1_3_0_Spec ComplianceFrameworkSpec = ComplianceFrameworkSpec{
	FrameworkName: "CIS 1.3.0",
	ComplianceControlGroupSpecs: []ComplianceControlGroupSpec{
		{
			...
			ComplianceControlSpecs: []ComplianceControlSpec{
				...
				{
					ControlName: "1.12 - Ensure credentials unused for 90 days or greater are disabled",
					ZeusCloudRules: []types.Rule{
				...
				{
					ControlName: "1.20 - Ensure that S3 Buckets are configured with 'Block public access (bucket settings)'",
					ZeusCloudRules: []types.Rule{
						s3.BlockPublicAccessConfig{},
					},
				},
				{
					ControlName:    "1.21 - Ensure that IAM Access analyzer is enabled",
					ZeusCloudRules: []types.Rule{},
					Comment:        "ZeusCloud is working on rule(s) to verify this control.",
				},
				{
					ControlName:    "1.22 - Ensure IAM users are managed centrally via identity federation or AWS Organizations for multi-account environments",
					ZeusCloudRules: []types.Rule{},
					Comment:        "This control requires manual verification.",
				},
			},
