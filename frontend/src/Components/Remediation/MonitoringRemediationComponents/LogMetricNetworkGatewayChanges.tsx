...
// gatewaysexport 
export const LogMetricNetworkGatewayChanges = () => {
    ...
    return (
        <>
            ...
            on filter pattern provided which checks for network gateway changes
    ...
    --metric-transformations metricName= \`<network_gw_changes_metric>\`,
