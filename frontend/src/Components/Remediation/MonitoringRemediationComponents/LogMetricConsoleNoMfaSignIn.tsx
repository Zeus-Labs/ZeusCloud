...
// sign-in without MFA
export const LogMetricConsoleNoMfaSignIn = () => {
    ...
    return (
        <>
            ...
            on filter pattern provided which checks for AWS Management Console sign-in 
            without MFA and the <cloudtrail_log_group_name>."/>
