...
// 3.13 Ensure a log metric filter and alarm exist for route table 
// changes 
export const LogRouteTableChanges = () => {
    ...
    return (
        <>
            ...
            on filter pattern provided which checks for route table
    ...
    --metric-transformations metricName= \`<route_table_changes_metric>\`
            ,metricNamespace='CISBenchmark',metricValue=1 
    --filter-pattern '{ ($.eventName = CreateRoute) || 
