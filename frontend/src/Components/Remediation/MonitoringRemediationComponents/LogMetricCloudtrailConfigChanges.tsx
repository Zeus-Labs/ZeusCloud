...
export const LogMetricCloudtrailConfigChanges = () => {
    ...
    return (
        <>
            ...
            on filter pattern provided which checks for cloudtrail
            configuration changes and the <cloudtrail_log_group_name>."/>
    ...
    --filter-pattern '{($.eventName = CreateTrail) || 
