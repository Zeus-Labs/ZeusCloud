...
import KeyValueList from "../Components/Explore/keyValueList";
...
export default function Explore() {
    ...
    useEffect(()=>{
        selectedNodeInfo.data.length>0 ? setAllRows(assetInstance?.getAllRows(selectedNodeInfo)) : setAllRows([]);
    },[selectedNodeInfo])

    useEffect(()=>{
        allTableRows.length>=0 && tableScrollRef.current?.scrollIntoView({behavior:"smooth"})
    },[allTableRows,tableScrollRef])
                ...
                <div className="flex flex-col mx-auto w-11/12">
                    <div className="flex flex-row justify-between items-center">
                        ...
                        {assetInstance!==null && allTableRows.length>0 && 
                            <div ref={tableScrollRef} className="mt-8 mb-4 overflow-scroll w-full shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                                    <TableComp 
                                        tableFixed={true}
